...
function Signup(){
    ...
    return(
      ...
      <div className="sm:w-[80%] md:w-[70%] lg:w-[60%] h-[550px] flex rounded-tr-[100px] rounded-bl-[100px] overflow-hidden shadow-2xl bg-white/90 backdrop-blur-xl">
        ...
        <form>
          <h1 className="tfont text-4xl font-bold text-gray-800 mb-10">Signup</h1>
          ...
          <div className="flex flex-col gap-4 w-full max-w-xs">
            ...
            {/* <button className="mt-4 bg-[#5AC1F0] text-white py-2 rounded-lg hover:bg-[#4b9187] transition-all">
              Send
                  ...
                  id="submit_btn"
                  type="submit"
                  className="group relative  overflow-hidden rounded-xl bg-gradient-to-br from-[#5AC1F0] to-blue-600 my-2 py-2 font-medium text-white shadow-lg transition hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <span className="relative z-10 cursor-pointer">creat</span>
